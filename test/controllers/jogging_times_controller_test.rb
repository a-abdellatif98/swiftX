...
class JoggingTimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create jogging_time" do
    assert_difference("JoggingTime.count") do
      post jogging_times_url, params: { jogging_time: { date: @jogging_time.date, distanse: @jogging_time.distanse, time: @jogging_time.time } }
    end
  ...
  test "should update jogging_time" do
    patch jogging_time_url(@jogging_time), params: { jogging_time: { date: @jogging_time.date, distanse: @jogging_time.distanse, time: @jogging_time.time } }
